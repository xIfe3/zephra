    ...
    >
      ...
      <div
        ...
        style={{
          ...
          left: -100,
          background:
            "radial-gradient(circle, rgba(0,200,255,.08), transparent 70%)",
          filter: "blur(120px)",
          borderRadius: "50%",
          pointerEvents: "none",
        }}
      ...
      <div
        ...
        style={{
          ...
          left: "40%",
          background:
            "radial-gradient(circle, rgba(123,94,167,.1), transparent 70%)",
          filter: "blur(120px)",
          borderRadius: "50%",
          pointerEvents: "none",
        }}
      ...
      >
        ...
        {/* Headline */}
        <h1
          className="font-syne anim-fadeup-1"
          style={{
            fontWeight: 800,
        ...
        >
          {[
            ...
            <div key={label}>
              <div
                className="font-syne gradient-text-white"
                style={{ fontWeight: 800, fontSize: "2.2rem", lineHeight: 1 }}
              >
                {num}
              </div>
              <div
